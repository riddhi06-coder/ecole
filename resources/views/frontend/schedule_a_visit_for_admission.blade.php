...
<body>
    ...
    <main class="main">
        ...
        <form action="{{ route('admission.store') }}" method="POST" id="schedulevisitForm">
            @csrf
            ...
            <section class="apply-for-admission-one-sec">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="apply-for-admission-choose-sec">
                            <div class="form-check applyforad-choose-form-check">
                            <input class="form-check-input" type="radio" name="radioDefault" id="schedule_a_visit" data-type="2" checked>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(".apply-other-info-btn button").on("click", function (e) {
                ...
                // ✅ Grade comparison using static + dynamic grade names
