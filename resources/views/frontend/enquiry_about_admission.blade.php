                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <div class="form-check applyforad-choose-form-check">
                            <input class="form-check-input" type="radio" name="radioDefault" id="apply_for_admission">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="apply-for-admission-choose-sec">
                        <div class="form-check applyforad-choose-form-check">
                            <input class="form-check-input" type="radio" name="radioDefault" id="enquiry_for_admission" checked>
