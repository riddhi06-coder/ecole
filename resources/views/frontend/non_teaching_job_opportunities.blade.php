...
<body>
    ...
    <main class="main">
        ...
        <section class="ecolemon-breadcrumb-sec ecol-career-breadcrumb-sec" style="background-image: url('{{ asset('uploads/careers/'.$non_teaching_job_opportunities_banner->banner_image) }}'); 
                    background-size: cover; 
                    background-position: center;">
            <div class="container">
                <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <h1>{{  $non_teaching_job_opportunities_banner->banner_heading ? $non_teaching_job_opportunities_banner->banner_heading : 'What sets us apart?' }}</h1>
                    <ul class="bread-list">
                    ...
                    <li class="active"><a href="javascript:void(0)">{{  $non_teaching_job_opportunities_banner->banner_heading ? $non_teaching_job_opportunities_banner->banner_heading : 'What sets us apart?' }}</a></li>
                    </ul>
                </div>
                </div>
            </div>
                ...
                <div class="col-12 col-md-12">
                    <div class="non-teaching-job-opp-content-sec">
                        ...
                        <div class="non-teaching-job-opp-btn-sec">
                            <a href="{{ route('frontend.non_teaching_job_opportunities_form') }}" class="btn-ecol btn">Apply Now</a>
                        </div>
                    </div>
                </div>
            </div>
