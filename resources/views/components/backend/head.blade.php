 <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="icon" href="{{ asset('admin/assets/images/logo/logo-icon-1.webp') }}" type="image/x-icon">
    <link rel="shortcut icon" href="{{ asset('admin/assets/images/logo/logo-icon-1.webp') }}" type="image/x-icon">
    <title>Ecole Mondiale</title>
    <!-- Google font-->
