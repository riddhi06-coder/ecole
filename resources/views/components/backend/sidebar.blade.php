          ...
          <nav class="sidebar-main">
            ...
            <div id="sidebar-menu">
              <ul class="sidebar-links" id="simple-bar">
                ...
                <li class="sidebar-list {{ request()->routeIs('manage-policies.index', 'manage-learner-profile.index', 'manage-student-support.index','mmanage-universities.index','manage-university-page.index','manage-pyp.index','manage-myp.index','manage-diploma.index') ? 'active' : '' }}">
                  <i class="fa fa-thumb-tack"> </i>
                  <a class="sidebar-link sidebar-title" href="#">
                    <svg class="stroke-icon"> 
                  ...
                  <ul class="sidebar-submenu">
                    ...
                    <li>
                        <a class="submenu-title {{ request()->routeIs('manage-curriculum.*') ? 'active' : '' }}" href="#">
                            Curriculum Overview
                    ...
                    <li><a href="{{ route('manage-pyp.index') }}" class="{{ request()->routeIs('manage-pyp.index') ? 'active' : '' }}">IB PYP</a></li>
                    <li><a href="{{ route('manage-myp.index') }}" class="{{ request()->routeIs('manage-myp.index') ? 'active' : '' }}">IB MYP</a></li>
                    <li><a href="{{ route('manage-diploma.index') }}" class="{{ request()->routeIs('manage-diploma.index') ? 'active' : '' }}">IB Diploma</a></li>
                ...
                <li class="sidebar-list {{ request()->routeIs('manage-bulletin-category.index', 'manage-bulletin-listing.index','manage-bulletin-details.index') ? 'active' : '' }}">
                  ...
                  <li><a href="{{ route('manage-bulletin-listing.index') }}" class="{{ request()->routeIs('manage-bulletin-listing.index') ? 'active' : '' }}">Articles Listing</a></li> 
                  <li><a href="{{ route('manage-bulletin-details.index') }}" class="{{ request()->routeIs('manage-bulletin-details.index') ? 'active' : '' }}">Articles Details</a></li> 
                  </ul>
                </li>
                ...
                <li class="sidebar-list {{ request()->routeIs('manage-university-bath.index', 'manage-career.index') ? 'active' : '' }}">
                  ...
                  <ul class="sidebar-submenu">
                  <li><a href="{{ route('manage-career.index') }}" class="{{ request()->routeIs('manage-career.index','manage-job-postings.index') ? 'active' : '' }}">Page Details</a></li> 
                  <li>
