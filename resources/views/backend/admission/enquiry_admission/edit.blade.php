        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit Enquiry About Admission Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Enquiry About Admission</li>
                </ol>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-header">
                        <h4>Enquiry About Admission Form</h4>
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" 
                                        novalidate 
                                        action="{{ route('manage-enquiry-admission.update', $admission->id) }}" 
                                        method="POST" 
                                        ...
                                        <div class="col-12 text-end">
                                            <a href="{{ route('manage-enquiry-admission.index') }}" class="btn btn-danger px-4">Cancel</a>
