                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-home-features.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf

                                        <!-- Thumbnail Image -->
                                        <div class="col-md-6">
                                            <label class="form-label" for="image"> Background Image <span class="txt-danger">*</span> </label>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <table class="table table-bordered mt-5" id="featuresTable">
                                                <thead>
                                                    <tr>
                                                        <th>Feature Image <span class="txt-danger">*</span></th>
                                                        <th>Feature Name <span class="txt-danger">*</span></th>
                                                        <th>Action</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                        ...
                                        <div class="col-12 text-end">
                                            <a href="{{ route('manage-home-features.index') }}" class="btn btn-danger px-4">Cancel</a>
