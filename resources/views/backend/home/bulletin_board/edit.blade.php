            ...
            <div class="page-title">
              <div class="row">
                ...
                <ol class="breadcrumb">
                    ...
                    <a href="{{ route('manage-bulletin-board.index') }}">Home</a>
                    </li>
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate 
                                        action="{{ route('manage-bulletin-board.update', $bulletin_board->id) }}" 
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="section_title" type="text" 
                                                ...
                                                value="{{ old('section_title', $bulletin_board->section_title) }}">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="description" id="description" class="form-control" rows="4" 
                                                    placeholder="Enter description">{{ old('description', $bulletin_board->description) }}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <!-- Image Preview -->
                                            <div class="mt-2">
                                                @if($bulletin_board->image)
                                                    <img id="thumbnailPreview" src="{{ asset('uploads/home/' . $bulletin_board->image) }}" 
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="title" type="text" name="title" 
                                                ...
                                                value="{{ old('title', $bulletin_board->title) }}" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="date" type="date" name="date" 
                                                value="{{ old('date', $bulletin_board->date) }}" required>
                                            <div class="invalid-feedback">Please select a Date.</div>
                                        </div>

                                        <!-- Bulletin Description -->
                                        <div class="col-md-12">
                                            <label for="bulletin_description" class="form-label"> Description <span class="txt-danger">*</span></label>
                                            <textarea name="bulletin_description" id="bulletin_description" class="form-control" rows="4" 
                                                    placeholder="Enter Description" required>{{ old('bulletin_description', $bulletin_board->bulletin_description) }}</textarea>
                                            <div class="invalid-feedback">Please enter a Description.</div>
                                        </div>

                                        <!-- Form Actions -->
                                        <div class="col-12 text-end">
                                            <a href="{{ route('manage-bulletin-board.index') }}" class="btn btn-danger px-4">Cancel</a>
