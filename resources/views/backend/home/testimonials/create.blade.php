                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-testimonials.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="reviewer_details" type="text" name="reviewer_details" placeholder="Enter Reviewer Details" required>
                                            <div class="invalid-feedback">Please enter a Reviewer Details.</div>
                                        </div>
