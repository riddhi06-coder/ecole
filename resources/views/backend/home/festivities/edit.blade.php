        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit Festivities Hosted Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Festivities Hosted</li>
                </ol>
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate 
                                        action="{{ route('manage-home-festivities.update', $festivities->id) }}" 
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <!-- Image Preview -->
                                            <div class="mt-2">
                                                @if(!empty($festivities->image))
                                                    <img id="thumbnailPreview" src="{{ asset('uploads/home/festivities/' . $festivities->image) }}" 
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="heading" type="text" name="heading" 
                                                placeholder="Enter Heading" value="{{ old('heading', $festivities->heading) }}" required>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="description" id="description" class="form-control" rows="4" 
                                                    placeholder="Enter Description" required>{{ old('description', $festivities->description) }}</textarea>
