        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit Programme Offered Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Programme Offered</li>
                </ol>
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate 
                                        action="{{ route('manage-programme-offered.update', $program_offered->id) }}" 
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="section_title" type="text" name="section_title" 
                                                ...
                                                value="{{ old('section_title', $program_offered->section_title) }}">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="description" id="description" class="form-control" rows="4" 
                                                    placeholder="Enter description">{{ old('description', $program_offered->description) }}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <!-- Image Preview -->
                                            <div class="mt-2">
                                                @if(!empty($program_offered->image))
                                                    <img id="thumbnailPreview" src="{{ asset('uploads/home/'.$program_offered->image) }}" 
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="program" type="text" name="program" placeholder="Enter Program" 
                                                value="{{ old('program', $program_offered->program) }}" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="url" type="text" name="url" placeholder="Enter Contact URL" 
                                                value="{{ old('url', $program_offered->url) }}" required>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="program_description" id="program_description" class="form-control" rows="4" 
                                                    placeholder="Enter Program Description" required>{{ old('program_description', $program_offered->program_description) }}</textarea>
