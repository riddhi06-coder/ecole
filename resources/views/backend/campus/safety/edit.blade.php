        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit Safety and Security Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                    <a href="{{ route('manage-safety-security.index') }}">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Edit Safety and Security</li>
                </ol>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-header">
                        <h4>Safety and Security Form</h4>
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate 
                                        action="{{ route('manage-safety-security.update', $sports->id) }}" 
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="banner_heading" type="text" 
                                                ...
                                                value="{{ old('banner_heading', $sports->banner_heading) }}" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="section_heading" type="text" 
                                                ...
                                                value="{{ old('section_heading', $sports->section_heading) }}" required>
                                        ...
                                        <div class="col-12 text-end">
                                            <a href="{{ route('manage-safety-security.index') }}" class="btn btn-danger px-4">Cancel</a>
