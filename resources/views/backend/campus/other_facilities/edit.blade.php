        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit Other Facilities Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                    <a href="{{ route('manage-other-facilities.index') }}">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Edit Other Facilities </li>
                </ol>
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate 
                                        action="{{ route('manage-other-facilities.update', $sports->id) }}" 
                                        ...
                                        <div class="col-12 text-end">
                                            <a href="{{ route('manage-other-facilities.index') }}" class="btn btn-danger px-4">Cancel</a>
