        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit Technology Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                    <a href="{{ route('manage-technology.index') }}">Home</a>
                    </li>
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate 
                                        action="{{ route('manage-technology.update', $technology->id) }}" 
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="banner_heading" type="text" name="banner_heading" 
                                                placeholder="Enter Banner Heading" value="{{ old('banner_heading', $technology->banner_heading) }}" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <small class="text-secondary"><b>Note: File size should be less than 2MB.</b></small><br>
                                            <small class="text-secondary"><b>Allowed formats: .jpg, .jpeg, .png, .webp, .svg</b></small>

                                            <!-- Image Preview -->
                                            <div class="mt-2">
                                                @if($technology->banner_image)
                                                    <img id="thumbnailPreview" src="{{ asset('uploads/campus-life/' . $technology->banner_image) }}" 
                                                        alt="Banner Preview" class="img-fluid rounded border" style="max-height:150px; background:black;">
                                                @else
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="section_heading" type="text" name="section_heading" 
                                                placeholder="Enter Section Heading" value="{{ old('section_heading', $technology->section_heading) }}" required>
                                            <div class="invalid-feedback">Please enter a Section Heading.</div>
                                        </div>

                                        <!-- Section Image -->
                                        <div class="col-md-6">
                                            <label class="form-label" for="section_image">Image <span class="txt-danger">*</span></label>
                                            ...
                                            <!-- Image Preview -->
                                            <div class="mt-2">
                                                @if($technology->section_image)
                                                    <img id="sectionImagePreview" src="{{ asset('uploads/campus-life/' . $technology->section_image) }}" 
                                                        alt="Section Preview" class="img-fluid rounded border" style="max-height:150px; background:black;">
                                                @else
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="description" id="editor" class="form-control" rows="4" placeholder="Enter description" required>{{ old('description', $technology->description) }}</textarea>
                                            <div class="invalid-feedback">Please enter a description.</div>
                                        </div>

                                        <!-- Form Actions -->
                                        <div class="col-12 text-end">
                                            <a href="{{ route('manage-technology.index') }}" class="btn btn-danger px-4">Cancel</a>
