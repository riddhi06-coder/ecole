        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit Gallery Videos Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Gallery Videos</li>
                </ol>
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" 
                                        novalidate 
                                        action="{{ route('manage-gallery-videos.update', $gallery_video->id) }}" 
                                        method="POST" 
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="title" type="text" name="title" 
                                                ...
                                                value="{{ old('title', $gallery_video->title) }}" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="video_iframe_url" type="text" name="video_iframe_url" 
                                                placeholder="Enter Video Iframe URL" 
                                                value="{{ old('video_iframe_url', $gallery_video->video_iframe_url) }}" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="video_url" type="text" name="video_url" 
                                                ...
                                                value="{{ old('video_url', $gallery_video->video_url) }}" required>
