            ...
            <div class="page-title">
              <div class="row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Media Centre </li>
                </ol>
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-media-center.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf


                                        @php
                                            $firstRecord = \App\Models\MediaCenter::first();
                                        @endphp
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <input class="form-control" id="url" type="text" name="url" placeholder="Enter URL">
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <input class="form-control" id="image" type="file" name="image" onchange="previewImage(event)">
                                            <div class="invalid-feedback">Please upload a Section image.</div>
                                            <small class="text-secondary"><b>Note: The file size should be less than 2MB.</b></small>
                                            <br>
                                            <small class="text-secondary"><b>Note: Only files in .jpg, .jpeg, .png, .webp, .svg format can be uploaded.</b></small>
                                            ...
                                            <!-- Image Preview -->
                                            <div class="mt-2">
                                                <img id="Preview" src="#" alt="Preview" class="img-fluid rounded border d-none" style="max-height: 150px; background:black;">
                                            </div>
                                        </div>
