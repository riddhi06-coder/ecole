            ...
            <div class="page-title">
              <div class="row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Cafeteria</li>
                </ol>
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-cafeteria.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="section_image" type="file" name="section_image" required onchange="previewSectionImage(event)">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="section_description" id="editor1" class="form-control" rows="4" placeholder="Enter description" required>{{ old('section_description') }}</textarea>
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <!-- Image Preview -->
                                            <div class="mt-2">
                                                <img id="bckImagePreview" src="#" alt="Preview" class="img-fluid rounded border d-none" style="max-height: 150px; background:black;">
                                            </div>
                                        </div>
