        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit IB Learner Profile Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                    <a href="{{ route('manage-learner-profile.index') }}">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Edit IB Learner Profile</li>
                </ol>
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                   <form class="row g-3 needs-validation custom-input" novalidate 
                                        action="{{ route('manage-learner-profile.update', $ib_learner->id) }}" 
                                        method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')

                                        {{-- Only show Banner/Section part if this is the first record --}}
                                        @if($ib_learner->id == 1)
                                            <!-- Section Title -->
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="banner_heading" type="text" name="banner_heading" 
                                                    value="{{ old('banner_heading', $ib_learner->banner_heading) }}" 
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                {{-- Image Preview --}}
                                                @if($ib_learner->banner_image)
                                                    <div class="mt-2">
                                                        <img id="thumbnailPreview" src="{{ asset('uploads/academics/'.$ib_learner->banner_image) }}" 
                                                            alt="Banner Preview" class="img-fluid rounded border" style="max-height:150px;">
                                                    </div>
                                                @endif
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="section_heading" type="text" name="section_heading" 
                                                    value="{{ old('section_heading', $ib_learner->section_heading) }}" 
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                {{-- Image Preview --}}
                                                @if($ib_learner->section_image)
                                                    <div class="mt-2">
                                                        <img id="sectionImagePreview" src="{{ asset('uploads/academics/'.$ib_learner->section_image) }}" 
                                                            alt="Section Preview" class="img-fluid rounded border" style="max-height:150px;">
                                                    </div>
                                                @endif
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea name="section_description" id="section_description" class="form-control" rows="4" 
                                                        placeholder="Enter Section description">{{ old('section_description', $ib_learner->section_description) }}</textarea>
                                        ...
                                        <div class="col-md-6 mt-5">
                                            ...
                                            <input class="form-control" id="title" type="text" name="title" 
                                                value="{{ old('title', $ib_learner->title) }}" placeholder="Enter Title" required>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="description" id="editor" class="form-control" rows="4" 
                                                    placeholder="Enter description" required>{{ old('description', $ib_learner->description) }}</textarea>
