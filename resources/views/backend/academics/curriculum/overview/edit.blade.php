        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit Curriculum Overview Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Curriculum Overview</li>
                </ol>
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate 
                                        action="{{ route('manage-curriculum.update', $curriculum->id) }}" 
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="ib_middle_desc" id="editor" class="form-control" rows="4" 
                                                    placeholder="Enter IB Middle Years Details" required>{{ old('ib_middle_desc', $curriculum->ib_middle_desc) }}</textarea>
                                            <div class="invalid-feedback">Please enter a IB Middle Years Details.</div>
                                        </div>

                                        <hr class="mt-5">

                                        <!-- IB Diploma Programme Details -->
                                        <div class="col-md-12">
                                            <label for="ib_diploma_desc" class="form-label">IB Diploma Programme Details<span class="txt-danger">*</span></label>
                                            <textarea name="ib_diploma_desc" id="ib_diploma_desc" class="form-control" rows="4" 
                                                    placeholder="Enter IB Diploma Programme Details" required>{{ old('ib_diploma_desc', $curriculum->ib_diploma_desc) }}</textarea>
