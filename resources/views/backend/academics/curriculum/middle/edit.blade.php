        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit IB Middle Years Programme Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit IB Middle Years Programme</li>
                </ol>
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate 
                                        action="{{ route('manage-ib-middle.update', $curriculum->id) }}" 
                                        ...
                                        <!-- IB Middle Years Details -->
                                        <div class="col-md-12">
                                            <label for="ib_middle_desc" class="form-label">IB Middle Years Details </label>
                                            <textarea name="ib_middle_desc" id="editor" class="form-control" rows="4" 
                                                    placeholder="Enter IB Middle Years Details">{{ old('ib_middle_desc', $curriculum->ib_middle_desc) }}</textarea>
