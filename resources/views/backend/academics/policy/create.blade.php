            ...
            <div class="page-title">
              <div class="row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Policies</li>
                </ol>
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-policies.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <h4># Policy Documents Section</h4>

                                        <div class="mt-5">
                                            <h5>Policy Documents Upload</h5>
