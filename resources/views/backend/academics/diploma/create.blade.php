            ...
            <div class="page-title">
              <div class="row">
                ...
                <ol class="breadcrumb">
                    ...
                    <a href="{{ route('manage-diploma.index') }}">Home</a>
                    </li>
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-diploma.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label" for="framework_heading">Curriculum Framework Heading </label>
                                            <input class="form-control" id="framework_heading" type="text" name="framework_heading" placeholder="Enter Curriculum Framework Heading">
                                        ...
                                        <div class="col-12 text-end">
                                            <a href="{{ route('manage-diploma.index') }}" class="btn btn-danger px-4">Cancel</a>
