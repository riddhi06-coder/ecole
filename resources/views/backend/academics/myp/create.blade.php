        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Add IB Middle Years Programme Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                    <a href="{{ route('manage-myp.index') }}">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Add IB Middle Years Programme</li>
                </ol>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-header">
                        <h4>IB Middle Years Programme Form</h4>
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-myp.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="col-md-6">
                                         ...
                                         <!-- Small Intro -->
                                        <div class="col-md-12">
                                            <label for="description" class="form-label">Small Intro <span class="txt-danger">*</span></label>
                                            <textarea name="small_intro" id="small_intro" class="form-control" rows="4" placeholder="Enter Small Intro" required>{{ old('small_intro') }}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="program_heading" type="text" name="program_heading" placeholder="Enter Program Heading" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="program_image" type="file" name="program_image" onchange="previewprogramImage(event)" required>
                                            ...
                                            <!-- Image Preview -->
                                            <div class="mt-2">
                                                <img id="programImagePreview" src="#" alt="Preview" class="img-fluid rounded border d-none" style="max-height: 150px; background:black;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="framework_heading" type="text" name="framework_heading" placeholder="Enter Curriculum Framework Heading" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="framework_image" type="file" name="framework_image" onchange="previewframeImage(event)" required>
                                            ...
                                            <!-- Image Preview -->
                                            <div class="mt-2">
                                                <img id="frameImagePreview" src="#" alt="Preview" class="img-fluid rounded border d-none" style="max-height: 150px; background:black;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <label for="description" class="form-label">Curriculum Description <span class="txt-danger">*</span></label>
                                            <textarea name="curriculum_description" id="editor" class="form-control" rows="4" placeholder="Enter Curriculum Description" required>{{ old('curriculum_description') }}</textarea>
                                        ...
                                        <div class="col-md-12 mt-5">
                                            <label for="description" class="form-label">Extra Information <span class="txt-danger">*</span></label>
                                            <textarea name="extra_info" id="extra_info" class="form-control" rows="4" placeholder="Enter Extra Information" required>{{ old('extra_info') }}</textarea>
                                            <div class="invalid-feedback">Please enter a Extra Information.</div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mt-5" id="document-upload-section">
                                            ...
                                            <small class="text-secondary d-block mt-1">
                                                Allowed formats: PDF, DOC, DOCX, XLSX. Max size 5MB.
                                            </small>

                                            <!-- 📄 File Preview Box -->
                                            <div id="document-preview" class="mt-3 position-relative border rounded bg-light p-3 d-none">
                                                ...
                                                <div class="d-flex align-items-center mt-3">
                                                    ...
                                                    <span id="document-name" class="text-dark fw-semibold"></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 text-end">
                                            <a href="{{ route('manage-myp.index') }}" class="btn btn-danger px-4">Cancel</a>
