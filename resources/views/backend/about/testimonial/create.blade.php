            ...
            <div class="page-title">
              <div class="row">
                ...
                <ol class="breadcrumb">
                    ...
                    <a href="{{ route('manage-about-testimonials.index') }}">Home</a>
                    </li>
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-about-testimonials.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label" for="section_heading">Heading</label>
                                            <input class="form-control" id="section_heading" type="text" name="section_heading" placeholder="Enter Heading">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="invalid-feedback">Please enter Reviewer.</div>
                                        </div>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea class="form-control editor" id="editor" name="testimony" rows="5" placeholder="Enter Description" required></textarea>
                                        </div>


                                        <!-- Form Actions -->
                                        <div class="col-12 text-end">
                                            <a href="{{ route('manage-about-testimonials.index') }}" class="btn btn-danger px-4">Cancel</a>
