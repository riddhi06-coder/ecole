                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate 
                                        action="{{ route('manage-about-testimonials.update', $set_apart->id) }}" 
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input class="form-control" id="reviewer" type="text" name="reviewer" placeholder="Enter Reviewer" value="{{ old('reviewer', $set_apart->reviewer) }}" required>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea class="form-control editor" id="editor" name="testimony" rows="5" placeholder="Enter Description" required>{{ old('testimony', $set_apart->testimony) }}</textarea>
                                        </div>
