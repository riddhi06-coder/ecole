                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-about-alumni.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input class="form-control" id="alumni_email" type="text" name="alumni_email" placeholder="Enter Alumni Email">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input class="form-control" id="alumni_name" type="text" name="alumni_name" placeholder="Enter Alumni Name" required>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input class="form-control" id="alumni_desc" type="text" name="alumni_desc" placeholder="Enter Alumni Description" required>
