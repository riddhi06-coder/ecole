                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-faculty-and-staff.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="extra_image" type="file" name="extra_image" required onchange="previewExtraImage(event)">
                                            ...
                                            <!-- Preview -->
                                            <div class="mt-2">
                                                <img id="extraImagePreview" src="#" alt="Preview" class="img-fluid rounded border d-none" style="max-height: 150px;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea class="form-control" id="extra_description" name="extra_description" rows="5" placeholder="Enter description" required></textarea>
