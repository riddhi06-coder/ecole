        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit Career Opportunities Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Career Opportunities</li>
                </ol>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-header">
                        <h4>Career Opportunities Form</h4>
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate 
                                        action="{{ route('manage-career.update', $opportunities->id) }}" 
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mt-2">
                                                <img id="thumbnailPreview" 
                                                    src="{{ $opportunities->banner_image ? asset('uploads/careers/' . $opportunities->banner_image) : '#' }}" 
                                                    alt="Preview" class="img-fluid rounded border {{ $opportunities->banner_image ? '' : 'd-none' }}" 
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="banner_heading" type="text" name="banner_heading" 
                                                value="{{ $opportunities->banner_heading }}" placeholder="Enter Banner Heading" required>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea class="form-control editor" id="editor" name="section_description" rows="5" required>{{ $opportunities->section_description }}</textarea>
                                        </div>
                                        ...
                                        <div class="mt-5">
                                            ...
                                            <table class="table table-bordered" id="unitsTable">
                                                ...
                                                <tbody>
                                                    @php
                                                        $units = json_decode($opportunities->teaching_details, true) ?? [];
                                                    @endphp

                                                    @forelse($units as $index => $unit)
                                                        <tr>
                                                            <td>
                                                                <input type="text" name="unit_titles[]" class="form-control" 
                                                                    value="{{ $unit['title'] }}" placeholder="Enter Title" required>
                                                            </td>
                                                            <td>
                                                                <label class="form-label">Upload Image</label>
                                                                <input type="file" name="unit_images[]" class="form-control" accept="image/*" 
                                                                    onchange="previewUnitImage(event, this)">
                                                                <small class="text-secondary"><b>Note: The file size should be less than 2MB.</b></small>
                                                                <br>
                                                                <small class="text-secondary"><b>Note: Only files in .jpg, .jpeg, .png, .webp format can be uploaded.</b></small>
                                                                <div class="mt-2">
                                        ...
                                        <!-- Description 2 -->
                                        <div class="col-md-12 mb-3">
                                            <label class="form-label" for="desc">Description 2<span class="txt-danger">*</span></label>
                                            <textarea class="form-control editor" id="desc" name="desc" rows="5" required>{{ $opportunities->desc }}</textarea>
                                        </div>
