...
class IBPrimaryController extends Controller
{
 
    public function index()
    {
        $curriculum = IBPrimary::wherenull('deleted_by')->get();
        return view('backend.academics.curriculum.primary.index', compact('curriculum'));
    }

    public function create(Request $request)
    {
        return view('backend.academics.curriculum.primary.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('manage-ib-primary.index')
    ...
    public function edit($id)
    {
        ...
        return view('backend.academics.curriculum.primary.edit', compact('curriculum'));
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            $industries = IBPrimary::findOrFail($id);
            $industries->update($data);

            return redirect()->route('manage-ib-primary.index')->with('message', 'Details deleted successfully!');
        } catch (Exception $ex) {
