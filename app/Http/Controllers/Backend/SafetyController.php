...
class SafetyController extends Controller
{
    ...
    {
        $sportsActivities = SafetySecurity::orderBy('id', 'asc')->wherenull('deleted_by')->get();
        return view('backend.campus.safety.index', compact('sportsActivities'));
    }

    public function create(Request $request)
    {
        return view('backend.campus.safety.create');
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $sports = new SafetySecurity(); // Make sure the model exists
    ...
    {
        $sports = SafetySecurity::findOrFail($id);
        return view('backend.campus.safety.edit', compact('sports'));
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            $industries = SafetySecurity::findOrFail($id);
            $industries->update($data);

            return redirect()->route('manage-safety-security.index')->with('message', 'Details deleted successfully!');
        } catch (Exception $ex) {
