...
class NonTeachingJobsController extends Controller
{

    public function index()
    {
        $teaching = ManageNonTeachingJob::orderBy('id', 'asc')->wherenull('deleted_by')->get();
        return view('backend.careers.opportunities.non_teaching.index',compact('teaching'));
    }

    public function create(Request $request)
    {
        return view('backend.careers.opportunities.non_teaching.create');
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            // ✅ Store in Database
            $teachingJob = new ManageNonTeachingJob();
            ...
            // ✅ Success Message
            return redirect()->route('manage-nonteaching-jobs.index')
    ...
    {
        $teaching = ManageNonTeachingJob::findOrFail($id);
        return view('backend.careers.opportunities.non_teaching.edit', compact('teaching'));
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            // ✅ Find record
            $teachingJob = ManageNonTeachingJob::findOrFail($id);
    ...
    public function destroy(string $id)
    {
        ...
        try {
            $industries = ManageNonTeachingJob::findOrFail($id);
            $industries->update($data);

            return redirect()->route('manage-nonteaching-jobs.index')->with('message', 'Details deleted successfully!');
        } catch (Exception $ex) {
