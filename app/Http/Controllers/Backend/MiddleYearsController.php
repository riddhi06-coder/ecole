...
class MiddleYearsController extends Controller
{
 
    public function index()
    {
        $curriculum = Myp::wherenull('deleted_by')->get();
        return view('backend.academics.myp.index', compact('curriculum'));
    }

    public function create(Request $request)
    {
        return view('backend.academics.myp.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('manage-myp.index')
            ->with('message', 'Program details have been successfully saved!');
    }

    public function edit($id)
    {
        $curriculum = Myp::findOrFail($id);
        return view('backend.academics.myp.edit', compact('curriculum'));
    }

    public function update(Request $request, $id)
    {
        $pyp = Myp::findOrFail($id);
    ...
    public function destroy(string $id)
    {
        ...
        try {
            $industries = Myp::findOrFail($id);
            $industries->update($data);

            return redirect()->route('manage-myp.index')->with('message', 'Details deleted successfully!');
        } catch (Exception $ex) {
