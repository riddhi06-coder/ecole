...
class GovernanceController extends Controller
{
    ...
    {
        $records = Governance::wherenull('deleted_by')->get();
        return view('backend.about.governance.index', compact('records'));
    }


    public function create(Request $request)
    {
        return view('backend.about.governance.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('manage-governance.index')->with('message', 'Details successfully added.');
    }

    public function edit($id)
    {
        $set_apart = Governance::findOrFail($id);
        return view('backend.about.governance.edit', compact('set_apart'));
    }
    ...
    {
        // Find the record
        $setApart = Governance::findOrFail($id);
        ...
        return redirect()->route('manage-governance.index')->with('message', 'Details successfully updated.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            $industries = Governance::findOrFail($id);
            $industries->update($data);

            return redirect()->route('manage-governance.index')->with('message', 'Details deleted successfully!');
        } catch (Exception $ex) {
