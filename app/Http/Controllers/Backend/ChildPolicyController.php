...
class ChildPolicyController extends Controller
{
    ...
    {
        $records = ChildPolicy::wherenull('deleted_by')->get();
        return view('backend.about.child_policy.index', compact('records'));
    }

    public function create(Request $request)
    {
        return view('backend.about.child_policy.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('manage-child-safeguarding-policy.index')->with('message', 'Details successfully added.');
    }

    public function edit($id)
    {
        $set_apart = ChildPolicy::findOrFail($id);
        return view('backend.about.child_policy.edit', compact('set_apart'));
    }

    public function update(Request $request, $id)
    {
        // Find the record
        $setApart = ChildPolicy::findOrFail($id);
        ...
        return redirect()->route('manage-child-safeguarding-policy.index')->with('message', 'Details successfully updated.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            $industries = ChildPolicy::findOrFail($id);
            $industries->update($data);

            return redirect()->route('manage-child-safeguarding-policy.index')->with('message', 'Details deleted successfully!');
        } catch (Exception $ex) {
