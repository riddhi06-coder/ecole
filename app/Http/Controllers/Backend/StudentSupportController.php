...
class StudentSupportController extends Controller
{
    ...
    {
        $ib_learner = StudentSupport::wherenull('deleted_by')->get();
        return view('backend.academics.student_support.index', compact('ib_learner'));
    }

    public function create(Request $request)
    {
        return view('backend.academics.student_support.create');
    }
    ...
    public function store(Request $request){
        ...
        try {
            ...
            // ✅ Store in Database
            $learnerProfile = new StudentSupport();
            ...
            // ✅ Success Message
            return redirect()->route('manage-student-support.index')
                ->with('message', 'Student Support section added successfully!');
    ...
    {
        $student_support = StudentSupport::findOrFail($id);
        return view('backend.academics.student_support.edit', compact('student_support'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $studentSupport = StudentSupport::findOrFail($id);
            ...
            return redirect()->route('manage-student-support.index')
                ->with('message', 'Student Support section updated successfully!');
    ...
    public function destroy(string $id)
    {
        ...
        try {
            $industries = StudentSupport::findOrFail($id);
            $industries->update($data);

            return redirect()->route('manage-student-support.index')->with('message', 'Details deleted successfully!');
        } catch (Exception $ex) {
