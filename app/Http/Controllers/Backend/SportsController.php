...
class SportsController extends Controller
{
    ...
    {
        $sportsActivities = SportsActivity::orderBy('id', 'asc')->wherenull('deleted_by')->get();
        return view('backend.campus.sports.index', compact('sportsActivities'));
    }

    public function create(Request $request)
    {
        return view('backend.campus.sports.create');
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $sports = new SportsActivity(); // Make sure the model exists
            ...
            return redirect()->route('manage-sports-activities.index')
    ...
    {
        $sports = SportsActivity::findOrFail($id);
        return view('backend.campus.sports.edit', compact('sports'));
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            $industries = SportsActivity::findOrFail($id);
            $industries->update($data);

            return redirect()->route('manage-sports-activities.index')->with('message', 'Details deleted successfully!');
        } catch (Exception $ex) {
